...
const CSS_BLOCK = `
    ...
    .quiz-teaser-cta { display: flex; align-items: center; gap: .55rem; padding-left: 1rem; position: relative; z-index: 1; flex-shrink: 0; }
    .quiz-teaser-btn { font-weight: 700; font-size: 15px; color: var(--orange); white-space: nowrap; }
    .quiz-teaser-arrow { width: 22px; height: 22px; fill: none; stroke: var(--orange); stroke-width: 2.5; stroke-linecap: round; stroke-linejoin: round; transition: transform .3s ease; }
    .quiz-teaser:hover .quiz-teaser-arrow { transform: translateX(5px); }
    @media (max-width: 768px) {
      ...
      .quiz-teaser-cta { grid-column: 1 / -1; padding-left: 0; padding-top: .35rem; justify-content: flex-end; border-top: 1px dashed rgba(249,115,22,0.25); margin-top: .5rem; }
